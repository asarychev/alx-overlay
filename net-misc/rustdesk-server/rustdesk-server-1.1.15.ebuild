...
declare -A GIT_CRATES=(
	...
	[confy]="https://github.com/rustdesk-org/confy;83db9ec19a2f97e9718aef69e4fc5611bb382479"
	[default_net]="https://github.com/rustdesk-org/default_net;78f8f70cd85151a3a2c4a3230d80d5272703c02e"
	[machine-uid]="https://github.com/rustdesk-org/machine-uid;381ff579c1dc3a6c54db9dfec47c44bcb0246542"
	[reqwest]="https://github.com/rustdesk-org/reqwest;9cb758c9fb2f4edc62eb790acfd45a6a3da21ed3"
	[sysinfo]="https://github.com/rustdesk-org/sysinfo;90b1705d909a4902dbbbdea37ee64db17841077d"
	[tokio-socks]="https://github.com/rustdesk-org/tokio-socks;94e97c6d7c93b0bcbfa54f2dc397c1da0a6e43d3"
)
...
SRC_URI="https://github.com/rustdesk/${PN}/archive/refs/tags/${PV}.tar.gz -> ${P}.tar.gz
	https://github.com/rustdesk/hbb_common/archive/refs/tags/driver.tar.gz -> hbb_common.tar.gz
	${CARGO_CRATE_URIS}"
...
src_unpack() {
	cargo_src_unpack
	rm -rf "${WORKDIR}"/${P}/libs/hbb_common
	cp -a "${WORKDIR}"/hbb_common-driver "${WORKDIR}"/${P}/libs/hbb_common
}
